...
signal instance_big_strength_flower
signal show_area
signal hide_area
...
func _ready() :
	...
	red_circle = 0
	self.connect("instance_big_strength_flower", get_tree().root.get_node("Game/game_start"), "_on_big_strength_flower_item_pressed")
...
func _on_TextureButton_pressed():
	if 	red_circle == 0 :
		emit_signal("instance_big_strength_flower")
