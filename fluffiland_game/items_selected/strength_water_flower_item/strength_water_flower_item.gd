...
signal instance_strength_water_flower
signal show_area
signal hide_area
...
func _ready() :
	...
	red_circle = 0
	self.connect("instance_strength_water_flower", get_tree().root.get_node("Game/game_start"), "_on_strength_water_flower_item_pressed")
...
func _on_TextureButton_pressed():
	if 	red_circle == 0 :
		emit_signal("instance_strength_water_flower")
