...
var evolution_1 = "mega_clover_tree"
var evolution_1_text = "jungle_path"
var cost_text_1 = 500
...
var bush_scene = preload("res://entities/tree_produced-bigclover/tree_produced_ bigclover.tscn")
...
func _on_Timer_timeout():
	...
	if bush_time >= 60 and health == health_max :
		...
		if bush_produced <= 20 :
			...
			tree_bush.position.x = self.position.x - 175 + rngx.randf_range(0, spawn_area.size.x)
			tree_bush.position.y = self.position.y - 175 + rngy.randf_range(0, spawn_area.size.x)
