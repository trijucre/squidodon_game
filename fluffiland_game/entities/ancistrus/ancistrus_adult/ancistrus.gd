...
func _ready():
	...
	self.connect("ancistrus_birth", get_tree().root.get_node("Game"), "_on_ancistrus_birth")
	self.connect("ancistrus_death", get_tree().root.get_node("Game"), "_on_ancistrus_death")
