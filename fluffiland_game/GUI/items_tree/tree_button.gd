...
# var a = 2
# var b = "text"
var vegetal_texture_unclicked = preload ("res://GUI/items_tree/vegetal_tree/button/tree_button/tree_unclicked.png")
var vegetal_texture_clicked = preload ("res://GUI/items_tree/vegetal_tree/button/tree_button/tree_clicked.png")
