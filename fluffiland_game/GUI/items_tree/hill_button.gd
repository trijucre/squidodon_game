...
var environment_texture_unclicked = preload ("res://GUI/items_tree/environment_tree/environment_tree_buttons/hill/hill_unclicked.png")
var environment_texture_clicked = preload ("res://GUI/items_tree/environment_tree/environment_tree_buttons/hill/hill_clicked.png")
